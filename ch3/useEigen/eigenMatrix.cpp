...
int main(int argc, char **argv) {
     ...
     // The following is the same as matrix_dynamic
     // simpler
     MatrixXd matrix_x;
     ...
     cout << "sum: " << matrix_33.sum() << endl;            // elements sum
     ...
     // Usually solving by matrix decomposition, such as QR decomposition, the speed
     // will be much faster than direct inversion
